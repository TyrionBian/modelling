...
def data_spliter(df_src, label, report_dst, time_col='biz_report_expect_at', index_col='apply_risk_id', test_size=0.2, method='oot', random_state=7, group_key=None, drop_cols=None):
    """
    ...
    '''
    #--------------------------------------------------------------------#
    #-------以下是label_col（overdue_days）转label的逻辑-----------------#
    #--------------------------------------------------------------------#
