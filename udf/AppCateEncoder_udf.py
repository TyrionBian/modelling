...
if __name__ == '__main__':
    import os
    path = os.getcwd()
    subpath = path.split('modelling', 1)[0] + 'modelling/'
    if os.path.exists(subpath + 'modelling'):
        cate_dict = subpath + 'modelling/' + 'materials/cate_dict_20180806_v1.pkl'
    else:
        cate_dict = subpath + 'modellingdev/' + 'materials/cate_dict_20180806_v1.pkl'
